...
exports.InstituteValidations = void 0;
const zod_1 = require("zod");
// create institute validation schema
const create_institute_validationZodSchema = zod_1.z.object({
    body: zod_1.z.object({
        name: zod_1.z
            .string({
        ...
        website: zod_1.z
            ...
            .optional(),
        establishedAt: zod_1.z
            .string({ required_error: 'Establisheddate is required' })
            .refine(val => !isNaN(Date.parse(val)), 'Established date must be a valid date string')
            .optional(),
        isActive: zod_1.z
