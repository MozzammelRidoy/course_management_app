...
exports.getDateDifference = exports.formatDateToISOString = exports.isDateInRange = exports.Start_End_DateTime_Validation = void 0;
...
function isValidDate(dateString) {
    ...
    if (dateStringNormalized.includes('T') ||
 ...
 */
const Start_End_DateTime_Validation = (start_date, end_date) => {
    const now = new Date();
    // Validate start date
    if (start_date && !isValidDate(start_date)) {
        throw new AppError_1.default(400, 'start_date', 'Start date is not a valid date');
    }
    // Validate end date
    if (end_date && !isValidDate(end_date)) {
        throw new AppError_1.default(400, 'end_date', 'End date is not a valid date');
    }
    ...
    if (start < maxPastDate || end < maxPastDate) {
        throw new AppError_1.default(400, 'date_range', 'Date cannot be more than 100 years in the past');
    }
    if (start > maxFutureDate || end > maxFutureDate) {
        throw new AppError_1.default(400, 'date_range', 'Date cannot be more than 100 years in the future');
    }
    return { start, end };
};
exports.Start_End_DateTime_Validation = Start_End_DateTime_Validation;
/**
 ...
 */
const getDateDifference = (startDate, endDate, unit = 'milliseconds') => {
    const start = startDate instanceof Date ? startDate : new Date(startDate);
    const end = endDate instanceof Date ? endDate : new Date(endDate);
